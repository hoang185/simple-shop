...
__webpack_require__(/*! ./product */ "./resources/js/product.js"); //  * First we will load all of this project's JavaScript dependencies which
...
$(document).ready(function () {
  ...
  var parts = url.split("/"); // console.log(parts, 'parts')

  var last_part = parts[parts.length - 1]; // console.log(last_part, 'last param url');

  var leng_option = $('#sorter option').length; // console.log(url, 'url');

  for (var i = 2; i <= leng_option; i++) {
    var value_option = $('#sorter option:nth-child(' + i + ')').val().split("/");
    var last_value_option = value_option[value_option.length - 1]; // console.log(last_value_option, 'val op');
  ...
  $('#sorter').change(function () {
    sorter = $('#sorter option:selected').val() ? $('#sorter option:selected').val() : ''; // console.log(sorter)
