...
<center style="width: 100%; background-color: #f1f1f1;">
    <div style="display: none; font-size: 1px;max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all; font-family: Condensed-Regular;">
                    ...
                    @foreach($content as $item)
                        <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                            ...
                            <td valign="middle" width="20%" style="text-align:left; padding: 0 2.5em;">
                                <span class="price" style="color: #000; font-size: 20px;">{{ $item->price }}</span>
                            </td>
                        </tr>
                    @endforeach
                    <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                        <td valign="middle" width="80%" style="text-align:left; padding: 0 2.5em;">
                            <div class="product-entry">
                                ...
                                <div class="text">
                                    ...
                                    <p>Phí ship : {{ number_format(intval($item_price->ship_price),0,',','.') }}&nbsp;đ</p>
                                    <h3>Tổng số : {{ ($item_price->total>0) ?number_format($item_price->total+intval($item_price->ship_price)+$item_price->sale_price,0,',','.'):0 }}&nbsp;đ</h3>
                                </div>
                            </div>
                        </td>
                    </tr>
                                ...
                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                    <tr>
                                        <td style="text-align: left; padding-left: 5px; padding-right: 5px;">
                                            ...
                                            <ul>
                                                <li><span class="text">Email: info@ssstutter.com</span></li>
                                                <li><span class="text">Hotline: 086 993 6266</span></li>
                                            </ul>
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        <td style="text-align: left; padding-left: 10px;">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="{{ route('for-him.index') }}">For Him</a></li>
                                                <li><a href="{{ route('for-her.index') }}">For Her</a></li>
                                                <li><a href="{{ route('new-arrival.index') }}">New Arrivals</a></li>
                                            </ul>
                                        </td>
                                    </tr>
                                </table>
